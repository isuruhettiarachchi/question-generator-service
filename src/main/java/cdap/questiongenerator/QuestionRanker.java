...
import cdap.questiongenerator.ranking.*;
import cdap.questiongenerator.ranking.utils.BagOfWordsExtractor;
import cdap.questiongenerator.ranking.utils.PorterStemmer;
import cdap.questiongenerator.transducer.QuestionFeatureExtractor;
...
public class QuestionRanker implements Serializable {
    ...
    private QuestionRanker(String rankType) {
        ranker = RankFactory.createRanker(rankType);
    }
